...
Manipulate[
Show[
ParametricPlot[sol2,{t,0,b},PlotRange->Full,Epilog->{Red,PointSize[Large],Point[{{1,1},{0,0}}],Black,PointSize[Medium],Dynamic@Point[sol2/.t->a]}],
ParametricPlot[VenusOrbitDistance*{Cos[2Pi*(t/VenusOrbitTimeInSeconds)],-Sin[2Pi*(t/VenusOrbitTimeInSeconds)]},{t,0.01,a}]],{{a,0,"Mercury"},0,90000000},{{b,1000000,"solution length"},1,100000000}]

sol2={x[t],y[t]}/.NDSolve[{{x''[t],y''[t]}==(-GConstant*SolarMass*{x[t],y[t]})/Norm[{x[t],y[t]}]^3+(-GConstant*0.1*SolarMass*{x[t]-VenusX,y[t]-VenusY})/Norm[{x[t]-VenusX,y[t]-VenusY}]^3,{x[0],y[0]}=={MercuryInitialPositionX,MercuryInitialPositionY},{x'[0],y'[0]}=={MercuryInitialSpeedX,MercuryInitialSpeedY}},{x[t],y[t]},{t,0,9000000000}][[1]];
distance=Norm[sol2];
