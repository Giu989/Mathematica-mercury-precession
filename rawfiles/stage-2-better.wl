...
VenusX:=VenusOrbitDistance*Cos[ArcTan[VenusInitialPositionX,VenusInitialPositionY]+2Pi*(t/VenusOrbitTimeInSeconds)];
VenusY:=VenusOrbitDistance*Sin[-ArcTan[VenusInitialPositionX,VenusInitialPositionY]-2Pi*(t/VenusOrbitTimeInSeconds)];
...
EarthX:=EarthOrbitDistance*Cos[ArcTan[EarthInitialPositionX,EarthInitialPositionY]+2Pi*(t/EarthOrbitTimeInSeconds)];
EarthY:=EarthOrbitDistance*Sin[-ArcTan[EarthInitialPositionX,EarthInitialPositionY]-2Pi*(t/EarthOrbitTimeInSeconds)];
...
MarsX:=MarsOrbitDistance*Cos[ArcTan[MarsInitialPositionX,MarsInitialPositionY]+2Pi*(t/MarsOrbitTimeInSeconds)];
MarsY:=MarsOrbitDistance*Sin[-ArcTan[MarsInitialPositionX,MarsInitialPositionY]-2Pi*(t/MarsOrbitTimeInSeconds)];
MarsMass=6.39*10^23;
...
JupiterX:=JupiterOrbitDistance*Cos[ArcTan[JupiterInitialPositionX,JupiterInitialPositionY]+2Pi*(t/JupiterOrbitTimeInSeconds)];
JupiterY:=JupiterOrbitDistance*Sin[-ArcTan[JupiterInitialPositionX,JupiterInitialPositionY]-2Pi*(t/JupiterOrbitTimeInSeconds)];
...
SaturnX:=SaturnOrbitDistance*Cos[ArcTan[SaturnInitialPositionX,SaturnInitialPositionY]+2Pi*(t/SaturnOrbitTimeInSeconds)];
SaturnY:=SaturnOrbitDistance*Sin[-ArcTan[SaturnInitialPositionX,SaturnInitialPositionY]-2Pi*(t/SaturnOrbitTimeInSeconds)];
...
UranusX:=UranusOrbitDistance*Cos[ArcTan[UranusInitialPositionX,UranusInitialPositionY]+2Pi*(t/UranusOrbitTimeInSeconds)];
UranusY:=UranusOrbitDistance*Sin[-ArcTan[UranusInitialPositionX,UranusInitialPositionY]-2Pi*(t/UranusOrbitTimeInSeconds)];
...
NeptuneX:=NeptuneOrbitDistance*Cos[ArcTan[NeptuneInitialPositionX,NeptuneInitialPositionY]+2Pi*(t/NeptuneOrbitTimeInSeconds)];
NeptuneY:=NeptuneOrbitDistance*Sin[-ArcTan[NeptuneInitialPositionX,NeptuneInitialPositionY]-2Pi*(t/NeptuneOrbitTimeInSeconds)];
...
Plot[distance[t],{t,0,1000000}]
ListPlot[distancelist,AxesLabel->{"Time /50ks","Distance from sun /m"}]
